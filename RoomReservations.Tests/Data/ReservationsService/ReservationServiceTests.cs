...
public class ReservationServiceTests
{
    ...
    public async Task AreAnyRoomsReservedInDateRange_OneMatching_ReturnsTrue()
    {
        ...
        var result =
            await _reservationService.AreAnyRoomsReservedInDateRange([rooms[0]], date.AddDays(2), date.AddDays(3));
    ...
    public async Task AreAnyRoomsReservedInDateRange_OneMatchingButIgnored_ReturnsFalse()
    {
        ...
        var result =
            await _reservationService.AreAnyRoomsReservedInDateRange([rooms[0]], date, date.AddDays(3), reservation.Id);
    ...
    public async Task AreAnyRoomsReservedInDateRange_NoneMatching_ReturnsFalse()
    {
        ...
        var result =
            await _reservationService.AreAnyRoomsReservedInDateRange([rooms[1]], date.AddDays(2), date.AddDays(3));
