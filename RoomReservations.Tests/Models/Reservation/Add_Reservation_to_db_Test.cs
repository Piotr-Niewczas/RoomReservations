    ...
    public class Add_Reservation_to_db_Test
    {
        ...
        public void Add_Reservation_with_one_room_and_transaction_to_db()
        {
            var reservation = new RoomReservations.Models.Reservation
            {
                ...
                Rooms =
                [
                    new RoomReservations.Models.Room
                    {
                        Name = "Test Room",
            ...
            Assert.AreEqual(reservation.Rooms.Count, reservationFromDb.Rooms.Count);
            Assert.AreEqual(reservation.Rooms.First().Name, reservationFromDb.Rooms.First().Name);
